...
$(".submitbtns").append('<div id = "time-left">' + '<span class="time-left-quiz" style="background:#333333;color:#fff">hii</span>');


setInterval(function(){
   var a=$("#quiz-timer span").text();
     $('.time-left-quiz').html(a);
